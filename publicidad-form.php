...
<center>
	<form class="contact_form" action="publicidad.php" method="post">
    <ul>
        <li>
             <h2>Publicidad </h2>
        </li>
        <li>
            <label for="name">Empresa o persona:</label>
            <input name="procedencia" type="text" required id="empresa"  placeholder="" />
        </li>
        <li>
            <label for="name">espacio de publicacion:</label>
            <input type="text" name="espacio" placeholder="" required />
        </li>
       
        <li>
            <label for="name">tiempo de la publicacion:</label>
            <input name="tiempo" type="text" required id="curso"  placeholder="" />
        </li>
         <li>
            <label for="name">Contenido:</label>
            <input name="contenido" type="text"  id="curso"  placeholder="" />
        </li>
